class ComplexNumber:
    ...
    def __eq__(self, other):
        return ((self.real_part == other.real_part)
                and (self.im_part == other.im_part))
    ...
    def __truediv__(self, other):
        divisor = (other.real_part * other.real_part + other.im_part * other.im_part)
        real = other.real_part / divisor
        imaginary = -other.im_part / divisor
        recip = ComplexNumber(real, imaginary)
        return self * recip
